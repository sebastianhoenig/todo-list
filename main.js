...
/* harmony import */ var _todo_item__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./todo-item */ "./src/modules/todo-item.js");
/* harmony import */ var _project__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./project */ "./src/modules/project.js");
/* harmony import */ var _todo_item_helper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./todo-item-helper */ "./src/modules/todo-item-helper.js");
/* harmony import */ var _project_helper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./project-helper */ "./src/modules/project-helper.js");
    ...
    myDataDeserialized.forEach((project) => {
      ...
      if (project.todoArray) {
        project.todoArray.forEach((todo) => {
          let newTodo = (0,_todo_item_helper__WEBPACK_IMPORTED_MODULE_3__.createNewTodo)(
            todo.title,
      ...
      let newProject = (0,_project_helper__WEBPACK_IMPORTED_MODULE_4__.createNewProject)(project.name, todoArray, project.id);
...
function deleteTodo(e, currProject) {
  ...
  setData(_projectlist__WEBPACK_IMPORTED_MODULE_0__.projectList);
}
...
function declineEditTodo(editedTodo, currDiv, currProject, element) {
  ...
  duedate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(editedTodo.getDueDate(), "dd-MM-yyyy");
...
function acceptEditTodo(
  ...
  if (
    textInput.value !== "" &&
    dateInput.value !== "" &&
    (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(dateInput.value) >= currDay
  ) {
    let newDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(dateInput.value);
    let title = document.createElement("div");
    title.textContent = textInput.value;
    editedTodo.setTitle(textInput.value);
    title.classList.add("todo-text");
    let duedate = document.createElement("div");
    duedate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(newDate, "dd-MM-yyyy");
...
function editTodo(e, currProject, element) {
  ...
  if (currDiv.classList.contains("todo")) {
    ...
    let date = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(editedTodo.getDueDate(), "yyyy-MM-dd");
...
function createTodo(element, currProject, container) {
  ...
  let duedate = document.createElement("div");
  duedate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(element.getDueDate(), "dd-MM-yyyy");
  let deleteButton = document.createElement("button");
  deleteButton.innerHTML = '<i class="fas fa-times"></i>';
  let editButton = document.createElement("button");
  editButton.innerHTML = `<i class="fas fa-edit"></i>`;
...
function addNewTodo(
  ...
  if (
    addToDoInput.value !== "" &&
    addToDoDate.value !== "" &&
    (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(addToDoDate.value) >= currDay
  ) {
    let isoDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(addToDoDate.value);
    let newToDo = new _todo_item__WEBPACK_IMPORTED_MODULE_1__.TodoItem(addToDoInput.value, isoDate);
...
function createProject(element, projects) {
  ...
  projectDeleteButton.addEventListener("click", (e) => {
    if (!isEditOpen()) {
      deleteProject(e, _projectlist__WEBPACK_IMPORTED_MODULE_0__.projectList);
    }
  });
...
function activateProjectButton(projects) {
  ...
  addProjectInputButton.addEventListener("click", () => {
    addProject(
      addProjectInput.value,
      _projectlist__WEBPACK_IMPORTED_MODULE_0__.projectList,
      addProjectButton,
      addProjectInput,
      addProjectInputButton,
      cancelProjectInputButton,
  ...
  if (e.target.textContent === "Today") {
    for (let i = 0; i < projectList.getProjectList().length; i++) {
      ...
      for (let j = 0; j < project.getToDos().length; j++) {
        ...
        if (
          (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(today, "yyyy-mm-dd") ===
          (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(possibleCandidate, "yyyy-mm-dd")
        ) {
...
function changeActiveProject(e, projects) {
  ...
  if (
    ...
    renderSpecial(_projectlist__WEBPACK_IMPORTED_MODULE_0__.projectList, e);
  } else {
    let projectID = e.target.parentElement.id;
    e.target.parentElement.classList.add("active");
    renderToDos(_projectlist__WEBPACK_IMPORTED_MODULE_0__.projectList.getProjectList()[projectID - 2]);
  }
}
...
function addProject(
  ...
  if (value !== "") {
    let newProject = new _project__WEBPACK_IMPORTED_MODULE_2__.Project(value, [], 0);
    projectList.addToProjectList(newProject);
    projectList.setIds();
...
function createNewProject(title, todoArray, id) {
  ...
  let project = new _project_js__WEBPACK_IMPORTED_MODULE_0__.Project(title, todoArray, id);
  return project;
}
...
/* harmony export */ });
/* harmony import */ var _todo_item_helper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./todo-item-helper */ "./src/modules/todo-item-helper.js");
/* harmony import */ var _project_helper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./project-helper */ "./src/modules/project-helper.js");
...
/***/ "./src/modules/todo-item-helper.js":
/*!*****************************************!*\
  !*** ./src/modules/todo-item-helper.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function createNewTodo(title, dueDate, id, done) {
  let todo = new _todo_item__WEBPACK_IMPORTED_MODULE_0__.TodoItem(title, dueDate, id, done);
  return todo;
}
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_dom_render__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/dom-render */ "./src/modules/dom-render.js");
